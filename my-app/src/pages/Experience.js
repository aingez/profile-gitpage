    ...
    return (
        <div className='experience-outer'>
            <div className='experience-container'>
                ...
                <p className='exp-p'>
                    I was a member of the team that participated in the EVAT Electric Motorcycle Conversion Competition 2021. <br />
                    The competition was held by the Electrical Vehicle Association of Thailand (EVAT) <br />
                    The team was required to convert a gasoline motorcycle to an electric motorcycle. <br /><br /> 

                    We converted an abandoned Suzuki RC100 from one of our friends into an electric motorcycle. <br />
                ...
                <p className='exp-p'>
                    Since I was a student in Pre-Engineering Program and faculty of Electrical Engineering, <br />
                    I have learned about basic electronics theory, circuit analysis, and circuit design. <br />
                    along with laboratory experiments to verify the theory and design. <br />
                </p>
                <hr className='exp-line-small'/>
                <h3 className='exp-h3'>Related Hobby Projects</h3>
                <p className='exp-p'>
                    Most of my hobby projects are tinkering that mostly related to electronics. <br />
                    ...
                    I experienced in designing and 3D printing parts for my projects and shared some of them on Thingiverse. <br />
                    and of course, a lot of troubleshooting and practical problem solving of the 3D printer itself. <br /><br />

                    I currently build an open source 3D printer called Voron 2.4. <br />
                    And learned a lot from this project. both in mechanical, electrical, hardware and software aspects. <br />
                </p>
                <hr className='exp-line-small'/>
                ...
                <p className='exp-p'>
                    I have learned about programming since I was in Pre-Engineering Program. <br />
                    Mostly in Python and C programming languages. <br /><br />

                    I have done some projects that are related to Python programming languages during my study. <br />
